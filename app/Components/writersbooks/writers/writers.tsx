...
import cards from '../../../pages/writersbooks/writers/writerList'
...
export default () => {
    ...
    return(
        <div className={styles.container}>
            <h1 className={styles.title}><Link className={styles.link} href="/pages/writersbooks/writers">ავტორები</Link></h1>
